...
;(get-in data keys)
;data: Erişmek istediğiniz veri yapısı. Bu, genellikle bir harita olur, ancak bir vektör de olabilir.
;keys: Erişim yolu belirtilen sıradaki anahtar veya indekslerin bir koleksiyonu (örneğin, bir vektör veya bir liste).
